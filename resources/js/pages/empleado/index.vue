...
import IndexTable from '@/components/empleados/index-table.vue'
...
const info = "Nuevo Empleado";
const href = route('empleado.create');
const search = "Buscar Empleado";
const searchRoute = "/gasto";
</script>
