...
import IndexTable from '@/components/planillas/index-table.vue'
...
const info = "Nueva Planilla";
const href = route('planilla.create');
const search = "Buscar Pago de Planilla";
const searchRoute = "/planilla";
</script>
