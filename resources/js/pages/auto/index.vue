...
import IndexTable from '@/components/autos/index-table.vue'
...
const info = "Nuevo Auto";
const href = route('auto.create');
const search = "Buscar Auto";
const searchRoute = "/auto";
</script>
